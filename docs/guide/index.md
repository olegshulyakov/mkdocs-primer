...
Three pages, in the order you will want them:

- [Installation](installation.md) — install the package and point `theme.name` at it.
- [Configuration](configuration.md) — the theme options and the Markdown
  extensions worth turning on.
