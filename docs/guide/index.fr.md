...
Trois pages, dans l'ordre où elles vous serviront :

- [Installation](installation.md) — installer le paquet et pointer `theme.name`
  dessus.
- [Configuration](configuration.md) — les options du thème et les extensions
  Markdown qui valent la peine d'être activées.
